import numpy as np
from sklearn.ensemble import RandomForestRegressor as _sk_RandomForestRegressorParameters
...
class RandomForestRegressor(_sk_RandomForestRegressor):
    ...
    criterion : string, optional (default="friedman_mse")
        ...
        are "friedman_mse" for the mean squared error, which is equal to variance
